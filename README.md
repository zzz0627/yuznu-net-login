...
<p align="center">
  ...
  <a href="https://www.microsoft.com/windows"><img src="https://img.shields.io/badge/platform-Windows-lightgrey.svg" alt="Platform: Windows"></a>
</p>
...
- [🚀 快速开始](#-快速开始)
  ...
  - [3. 配置认证信息](#3-配置认证信息)
  - [4. 测试运行](#4-测试运行)
- [⚙️ 部署指南 (Windows Service)](#️-部署指南-windows-service)
- [🔧 常见问题 (FAQ)](#-常见问题-faq)
- [🛡️ 技术细节](#️-技术细节)
  - [流程图](#流程图)
  - [RC4 加密算法](#rc4-加密算法)
